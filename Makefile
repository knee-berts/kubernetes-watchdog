...
clean-deploy:
	@kubectl delete deploy kube-watchdog -n kube-system --ignore-not-found=true
	@kubectl delete secrets kube-watchdog kube-watchdog-aadclient -n kube-system --ignore-not-found=true
